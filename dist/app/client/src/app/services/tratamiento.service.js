...
let TratamientoService = class TratamientoService {
    ...
    getMedico(idFormacion) {
        ...
        return this.http.get(this.URL_API + '/medico/:idFormacion').pipe(operators_1.map((data) => {
            return data;
    ...
    getPaciente(nroDoc, tipoDoc) {
        return this.http.get(this.URL_API + '/paciente/' + nroDoc + '/' + tipoDoc).pipe(operators_1.map((data) => {
            console.log("el paciente es", data);
            return data;
        }));
    }
    getPacienteConsulta(nroDoc, tipoDoc) {
        return this.http.get(this.URL + '/paciente/' + nroDoc + '/' + tipoDoc).pipe(operators_1.map((data) => {
            console.log("el paciente es", data);
            return data;
        }));
    }
    getHCPaciente(idPaciente) {
        ...
        return this.http.get(this.URL_API + '/historia-clinica/paciente/' + idPaciente).pipe(operators_1.map((data) => {
    ...
    getHCPacienteConsulta(idPaciente) {
        //return this.http.put(this.URL_API + `/${elTratamiento._id}`, elTratamiento);
        return this.http.get(this.URL + '/historia-clinica/paciente/' + idPaciente).pipe(operators_1.map((data) => {
            console.log("La DATA en getHCPAciente tiene: ", data);
            console.log("A VERRRR la HistoriaClinica del PACIENTE tiene:", data[0]); //hc es un arreglo(no deberia) entonces me traigo el 1er elem del aregglo de hc, que es una hc
            console.log("A VER el id de la HC del paciente", data[0]._id);
            this.historiaClinica = data[0];
    ...
    getInfoAfecciones(idAfeccion) {
        ...
        return this.http.get(this.URL_API + '/historia-clinica/' + idAfeccion).pipe(operators_1.map((data) => {
    ...
    getInfoAfeccionesConsulta(idAfeccion) {
        console.log("entro a getinfoafecciones con ", idAfeccion);
        return this.http.get(this.URL + '/historia-clinica/' + idAfeccion).pipe(operators_1.map((data) => {
            // console.log("eldato desde service de afecciones es de tipo:", typeof data)
            return data;
        }), operators_1.catchError((err, caught) => {
            console.log("ERROOOOR");
    ...
    getInfoLaAfeccion(idUnaAfeccion) {
        ...
        return this.http.get(this.URL_API + '/afeccion/' + idUnaAfeccion).pipe(operators_1.map((data) => {
    ...
    getInfoLaAfeccionConsulta(idUnaAfeccion) {
        console.log("entro a get info de LA afeccion ");
        return this.http.get(this.URL + '/afeccion/' + idUnaAfeccion).pipe(operators_1.map((data) => {
            //  console.log("eldato desde service de afecciones de hc:", data)
            // const nombreAfeccion: any=data.nom
    ...
    getDiagnostico() {
        ...
        return this.http.get(this.URL_API + '/diagnostico/' + this.infoAfeccion.diag._id).pipe(operators_1.map((data) => {
    ...
    getDiagnosticoConsulta() {
        ...
        return this.http.get(this.URL + '/diagnostico/' + this.infoAfeccionConsulta.diag._id).pipe(operators_1.map((data) => {
            console.log("El dato que trae de diagnostico es ", data);
            return data;
        }), operators_1.catchError((err, caught) => {
            console.error(err);
    ...
    getDatosTratamiento() {
        ...
        return this.http.get(this.URL + '/tratamiento/' + this.infoAfeccionConsulta.tratamiento[0]._id).pipe(operators_1.map((data) => {
    ...
    getMedicacion(nombre) {
        ...
        return this.http.get(this.URL_API + '/medicacion/' + nombre).pipe(operators_1.map((data) => {
    ...
    getTratamientosxMedico(idMedico, fechaDesde, fechaHasta) {
        ...
        return this.http.get(this.URI + '/tratamiento/' + idMedico + '?fechaDesde=' + fechaDesde + '&fechaHasta=' + fechaHasta).pipe(operators_1.map((data) => {
            console.log("tratamiento", data);
            return data;
        }), operators_1.catchError(this.handleError('getTratamientosxMedico', [])));
    }
