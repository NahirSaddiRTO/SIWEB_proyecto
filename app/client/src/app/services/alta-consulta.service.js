...
let ConsultaService = class ConsultaService {
    ...
    getCentroSalud() {
        return this.http.get(this.URI + '/centro-salud').pipe((0, operators_1.map)((data) => {
            return data;
    ...
    getPaciente(nroDni, tipoDni) {
        ...
        return this.http.get(this.URI + '/paciente/' + tipoDni + '/' + nroDni).pipe((0, operators_1.map)((data) => {
            console.log("paciente", data);
            return data;
        }), (0, operators_1.catchError)(this.handleError('getPaciente', [])));
    }
    getConsultasPaciente(idPaciente, fechaDesde) {
        console.log(this.URI + '/consulta/paciente/' + idPaciente + '?fechaDesde=' + fechaDesde);
        return this.http.get(this.URI + '/consulta/paciente/' + idPaciente + '?fechaDesde=' + fechaDesde).pipe((0, operators_1.map)((data) => {
            console.log("consulta", data);
            return data;
        }), (0, operators_1.catchError)(this.handleError('getConsultasPaciente', [])));
    }
    getAfecciones() {
        return this.http.get(this.URI + '/afecciones').pipe((0, operators_1.map)((data) => {
            return data;
        }), (0, operators_1.catchError)((err, caught) => {
            console.error(err);
            throw err;
    ...
    getMedicaciones(idMedicacion) {
        ...
        return this.http.get(this.URI_CM + '/medicaciones/' + idMedicacion).pipe((0, operators_1.map)((data) => {
            console.log("IMedicaciones", data);
            return data;
        }), (0, operators_1.catchError)(this.handleError('getMedicaciones', [])));
    }
};
